...
<Introduction
  name="Auctioneer"
  description="A local auction site for students and teachers."
/>
...
Auctioneer is a booking site for noroff students. It was given as a final exam the 4th semester at Noroff.
The main purpose of the app is to give the user the ability to bid on items, view and search for items.
...
<Images desk1="/holidazefrontpage.png" desk2="/holidazeexplore.png" mobile="/Holidazemobile.png" />
</section>
