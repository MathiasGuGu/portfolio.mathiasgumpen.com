const id = "Tasktracker.mdx";
						const collection = "projects";
						const slug = "tasktracker";
					...
					,title:"Tasktracker",description:"Track your task with intuative design, motivation and a sense of accomplishment.",liveDemo:"https://bookatholidaze.netlify.app",githubRepo:"https://github.com/MathiasGuGu/Holidaze"};
						const _internal = {
							type: 'content',
							filePath: "/Users/magugu/Documents/Developer/Noroff - Tasks, Courses, CAs/Course Assignment/portfolio/src/content/projects/Tasktracker.mdx",
							rawData: undefined,
						};
