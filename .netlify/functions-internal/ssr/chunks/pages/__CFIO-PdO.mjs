...
let lookupMap = {};
lookupMap = {"projects":{"type":"content","entries":{"tasktracker":"/src/content/projects/Tasktracker.mdx","ecom":"/src/content/projects/ecom.mdx","holidaze":"/src/content/projects/holidaze.mdx"}},"blog":{"type":"content","entries":{"markdown-style-guide":"/src/content/blog/markdown-style-guide.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/markdown-style-guide.mdx": () => import('../markdown-style-guide_C4ui-4HZ.mjs'),"/src/content/projects/Tasktracker.mdx": () => import('../Tasktracker_CRa0h6qh.mjs'),"/src/content/projects/ecom.mdx": () => import('../ecom_CXS0wLd7.mjs'),"/src/content/projects/holidaze.mdx": () => import('../holidaze_It93DSJ8.mjs')});
...
}, "/Users/magugu/Documents/Developer/Noroff - Tasks, Courses, CAs/Course Assignment/portfolio/node_modules/astro/components/ViewTransitions.astro", void 0);

const $$MainLayout = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="en" data-theme="light"> <head>${renderComponent($$result, "BaseHead", $$BaseHead, { "title": SITE_TITLE, "description": SITE_DESCRIPTION })}${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, {})} <main${addAttribute(renderTransition($$result, "flkhkp3x"), "data-astro-transition-scope")}> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
